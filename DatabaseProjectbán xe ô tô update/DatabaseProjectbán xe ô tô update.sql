...
CREATE LOGIN [nhanvienA]
    WITH PASSWORD = N'tbcllt|4nndygtkekdO{tIetmsFT7_&#$!~<cRAef~|l7nzl';


GO

CREATE LOGIN [nhanvien_ha_dong]
    WITH PASSWORD = N't|bclt|nnygtkek{;RtIetefmsFT7_&#$!~<|lnzlk|pCyga';


GO

CREATE USER [NV_BanHang] FOR LOGIN [nhanvienA];


GO

CREATE USER [nhanvien_ha_dong] FOR LOGIN [nhanvien_ha_dong];


GO

ALTER ROLE [db_datareader] ADD MEMBER [nhanvien_ha_dong];
...
GRANT SELECT
    ON OBJECT::[dbo].[OTo] TO [NV_BanHang]
    AS [dbo];


GO

GRANT CONNECT TO [nhanvien_ha_dong];


GO

GRANT SELECT
    ON OBJECT::[dbo].[KhachHang] TO [NV_BanHang]
    AS [dbo];


GO

GRANT CONNECT TO [NV_BanHang];
...
GRANT SELECT
    ON OBJECT::[dbo].[vw_DoanhThuTheoXe] TO [NV_BanHang]
    AS [dbo];
...
DENY DELETE
    ON OBJECT::[dbo].[HoaDon] TO [NV_BanHang]
    AS [dbo];
...
GRANT EXECUTE
    ON OBJECT::[dbo].[sp_BanXeMoi] TO [NV_BanHang]
    AS [dbo];
